...
const config = {
  ...
  tagline: 'A comprehensive guide to Physical AI using ROS 2, Gazebo, Unity, and NVIDIA Isaac',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://physical-ai-textbook-eta.vercel.app/',
  ...
  themeConfig:
    ...
    ({
      ...
      prism: {
        ...
        additionalLanguages: ['python', 'bash', 'json', 'yaml', 'docker', 'cpp', 'csharp'],
      },
      algolia: {
